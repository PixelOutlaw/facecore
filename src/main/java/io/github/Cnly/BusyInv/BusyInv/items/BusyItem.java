...
public class BusyItem {
     ...
     *
     * @param displayName The display name of the icon. Will use the icon's display name
     *                    when this is null.
     * @param icon        The icon
     * @param lores       The lore of the icon. Will use the icon's lore when this is
     *                    null.
     */
