...
public interface IPagedBusyMenu extends IBusyMenu {
     ...
     *
     * @param p           The player
     * @param naturalPage The page to open. Starts from 1.
     * @return this
     */
     ...
     * @throws IllegalStateException when this menu isn't open for the player
     */
     ...
     *
     * @param naturalPage The page. Starts from 1.
     * @param index       The position on the page. Usually starts from 0.
     * @param item        The item
     * @return this
     */
     ...
     *
     * @param p           The Player used for {@link BusyItem#getLookFor(Player)}
     * @param inv         The inventory
     * @param naturalPage The page to get items from. Starts from 1.
     * @return this
     */
     ...
     * @param naturalPage The page used for calling
